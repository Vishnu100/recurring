	...
	public SqlObjectConverters() {
		...
		registerJavaToSqlConverters(LocalDateTime.class, (obj) -> {
			...
			if (obj instanceof LocalDateTime) {
				return java.util.Date.from(((LocalDateTime) obj).toInstant(ZoneOffset.of(ZoneId.systemDefault().getId())));
			}
			throw new IllegalArgumentException("Cannot convert " + obj.getClass().getName() + " to java.sql.Date.");
		});
		// sql -> java:
		...
		registerSqlToJavaConverters(LocalDate.class, (obj) -> {
			...
			throw new IllegalArgumentException("Cannot convert " + obj.getClass().getName() + " to java.time.LocalDate.");
		});
		registerSqlToJavaConverters(LocalTime.class, (obj) -> {
			...
			throw new IllegalArgumentException("Cannot convert " + obj.getClass().getName() + " to java.time.LocalTime.");
		});
		registerSqlToJavaConverters(LocalDateTime.class, (obj) -> {
			...
			throw new IllegalArgumentException("Cannot convert " + obj.getClass().getName() + " to java.time.LocalDateTime.");
		});
	}
